...
/**
* Membuat variabel expectEmail untuk menyimpan informasi email sementara.
* @constant {string}
*/
...
/**
* Membuat variabel email untuk menyimpan njilai email yang didapatkan saat button ditekan.
* @constant {string}
*/
...
*/
  ...
  /* Comment : Memastikan bahwa nilai email dan passwrod sesuai dengan nilai yang tersimpan. */
  if (email == expectedEmail && password == expectedPassword) {

    /* Comment : Jika sesuai maka pprogram akan berpindah ke halaman home. */
    goToHome();
  } else {
